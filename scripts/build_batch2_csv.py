...
set in scripts/fluoride_nitride_sulfide_material_list.py.
...
from fluoride_nitride_sulfide_material_list import (  # noqa: E402
    MATERIALS_28, EXPECTED_SPACEGROUP, EXPERIMENTAL_DENSITY_OVERRIDE,
    FORCE_NO_MP, LITERATURE_DENSITY,
)

OUT_CSV = _ROOT / "data" / "batch2_28.csv"
