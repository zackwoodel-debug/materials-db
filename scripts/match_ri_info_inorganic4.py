#!/usr/bin/env python3
"""
scripts/match_ri_info_inorganic4.py
====================================
Matches scripts/inorganic4_material_list.CANDIDATES against the local RI.info catalog (authoritative) and writes
data/inorganic4_ri_matches.json + data/step1_selections_inorganic4.json. Same policy as match_ri_info_chalcogenides.py; in
...
from inorganic4_material_list import CANDIDATES, DEFERRED, EXCLUDED_PAGES, OUT_OF_FAMILY  # noqa: E402

RI = _ROOT / "refractiveindex_db" / "database"
MATCHES_OUT = _ROOT / "data" / "inorganic4_ri_matches.json"
SELECTIONS_OUT = _ROOT / "data" / "step1_selections_inorganic4.json"
